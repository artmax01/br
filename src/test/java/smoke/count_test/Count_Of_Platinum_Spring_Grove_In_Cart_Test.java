...
public class Count_Of_Platinum_Spring_Grove_In_Cart_Test extends BaseTest {

    @Test
    @TestName(name = "Check count of crestridge mattresses in cart and minicart icon")
    public void countOfSpringGroveInCart_Test() throws Exception {

        ItemEntity firstmattress = EntitiesFactory.getItem(FileIO.getDataFile("mattress/platinum_spring_grove.json"));
        ItemEntity secondmattress = EntitiesFactory.getItem(FileIO.getDataFile("updated_products/platinum_spring_grove_upd.json"));
